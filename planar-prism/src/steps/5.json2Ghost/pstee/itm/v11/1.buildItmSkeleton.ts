...
import type { RawItmAbilityV10 } from '@/steps/4.biffs2json/pstee/itm/v10/2.parseAbilities.types.js';
...
const writeEffect = (writer: Writer, effect: RawItmEffectV10): void => {
...
const writeAbility = (writer: Writer, ability: RawItmAbilityV10): void => {
...
const buildItmSkeletonV11 = (itm: RawItmV10, discover: DiscoverNext): string => {
...
export const buildItmSkeleton = (itm: RawItmV10, discover: DiscoverNext): string => {
  switch (itm.header.version) {
    case 'v10': return buildItmSkeletonV11(itm, discover);
    default: throw new Error(`Itm header version is out of range: '${itm.header.version}'`); // eslint-disable-line @typescript-eslint/restrict-template-expressions
  }
};
