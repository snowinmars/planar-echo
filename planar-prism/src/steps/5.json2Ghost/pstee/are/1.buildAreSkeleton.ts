...
import type { RawAreItemV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/7.parseItems.types.js';
import type { RawAreVertexV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/8.parseVertices.types.js';
import type { RawAreAmbientV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/9.parseAmbients.types.js';
import type { RawAreVariableV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/10.parseVariables.types.js';
...
import type { RawAreAutomapNoteV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/15.parseAutomapNotes.types.js';
import type { RawAreProjectileTrapV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/16.parseProjectileTraps.types.js';
import type { RawAreSongV10 } from '@/steps/4.biffs2json/pstee/are/v1.0/17.parseSong.types.js';
...
const writeVertices = (writer: Writer, propertyName: string, vertices: RawAreVertexV10[], offset: number): void => {
...
const writeActor = (writer: Writer, actor: RawAreActorV10): void => {
  writer.writeLine(`{`, 6);
...
const writeRegion = (writer: Writer, region: RawAreRegionV10): void => {
  writer.writeLine(`{`, 6);
...
const writeSpawnPoint = (writer: Writer, spawn: RawAreSpawnPointV10): void => {
  writer.writeLine(`{`, 6);
...
const writeItem = (writer: Writer, item: RawAreItemV10, offset: number): void => {
  writer.writeLine(`{`, offset);
...
const writeContainer = (writer: Writer, container: RawAreContainerV10): void => {
  writer.writeLine(`{`, 6);
...
const writeAmbient = (writer: Writer, ambient: RawAreAmbientV10): void => {
  writer.writeLine(`{`, 6);
...
const writeVariable = (writer: Writer, variable: RawAreVariableV10): void => {
  writer.writeLine(`{`, 6);
...
const writeDoorGeometry = (writer: Writer, propertyName: string, geometry: RawAreDoorV10['openedGeometry'], offset: number): void => {
  writer.writeLine(`${propertyName}: {`, offset);
...
const writeDoor = (writer: Writer, door: RawAreDoorV10): void => {
  writer.writeLine(`{`, 6);
...
const writeAnimation = (writer: Writer, animation: RawAreAnimationV10): void => {
  writer.writeLine(`{`, 6);
...
const writeTiledObject = (writer: Writer, tiled: RawAreTiledObjectV10): void => {
  writer.writeLine(`{`, 6);
...
const writeAutomapNote = (writer: Writer, note: RawAreAutomapNoteV10): void => {
  writer.writeLine(`{`, 6);
...
const writeProjectileTrap = (writer: Writer, trap: RawAreProjectileTrapV10): void => {
  writer.writeLine(`{`, 6);
...
const writeSong = (writer: Writer, song: RawAreSongV10): void => {
...
const writeRestInterruptions = (writer: Writer, rest: RawAreRestInterruptionsV10): void => {
...
export const buildAreSkeleton = (are: RawAre): string => {
  const writer = createWriter();
  const id = are.resourceName.split('.')[0]!;
