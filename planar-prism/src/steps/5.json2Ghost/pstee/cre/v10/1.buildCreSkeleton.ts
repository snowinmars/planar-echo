...
import { isRawCreV10 } from '../isRawCreV10.js';
...
const buildCreSkeletonV10 = (cre: RawCreV10, discover: DiscoverNext): string => {
...
const buildCreSkeletonV11 = (cre: RawCreV11, discover: DiscoverNext): string => {
  const npcLowercaseId = createNpcLowercaseId(cre.resourceName);
  ...
  writer.writeLine(`colorIndex1: ${cre.header.colorIndex1},`, 4);
  writer.writeLine(`colorIndex2: ${cre.header.colorIndex2},`, 4);
  writer.writeLine(`colorIndex3: ${cre.header.colorIndex3},`, 4);
  writer.writeLine(`colorIndex4: ${cre.header.colorIndex4},`, 4);
  writer.writeLine(`colorIndex5: ${cre.header.colorIndex5},`, 4);
  writer.writeLine(`colorIndex6: ${cre.header.colorIndex6},`, 4);
  writer.writeLine(`colorIndex7: ${cre.header.colorIndex7},`, 4);
...
export const buildCreSkeleton = (cre: RawCre, discover: DiscoverNext): string => {
  if (isRawCreV10(cre)) return buildCreSkeletonV10(cre, discover);
