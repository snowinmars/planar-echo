...
import { isCreWithTlkV10 } from './patchCres.types.js';
...
const buildCreSkeletonV10 = (cre: CreWithTlkV10, discover: DiscoverNext): string => {
...
const buildCreSkeletonV11 = (cre: CreWithTlkV11, discover: DiscoverNext): string => {
  const npcLowercaseId = createNpcLowercaseId(cre.resourceName);
...
const buildCreSkeleton = (cre: CreWithTlk, discover: DiscoverNext): string => {
  if (isCreWithTlkV10(cre)) return buildCreSkeletonV10(cre, discover);
  return buildCreSkeletonV11(cre, discover);
};

export default buildCreSkeleton;
