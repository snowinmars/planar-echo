...
export const buildCreSkeletonV11 = (cre: GhostCreV11, discover: DiscoverNext): string => {
  const npcLowercaseId = createNpcLowercaseId(cre.resourceName);

  discover({ type: 'who', name: npcLowercaseId });

  const writer = createWriter();
  writer.writeLine(`import type { GhostCreV11 } from '@planar/shared';`);
  writer.br();
  writer.writeLine('/**');
  ...
  writer.writeLine(`fistProficiency: ${cre.fistProficiency},`, 4);
  writer.writeLine(`edgedWeaponProficiency: ${cre.edgedWeaponProficiency},`, 4);
  writer.writeLine(`hammerProficiency: ${cre.hammerProficiency},`, 4);
  writer.writeLine(`axeProficiency: ${cre.axeProficiency},`, 4);
  writer.writeLine(`clubProficiency: ${cre.clubProficiency},`, 4);
  ...
  writer.writeLine(`overlaysOffset: ${cre.overlaysOffset},`, 4);
  writer.writeLine(`overlaysSize: ${cre.overlaysSize},`, 4);
  writer.writeLine(`murderIncrementBy: ${cre.murderIncrementBy},`, 4);
  writer.writeLine(`characterType: '${cre.characterType}',`, 4);
  writer.writeLine(`colorsCount: ${cre.colorsCount},`, 4);
  writer.writeLine(`colorIndex1: ${cre.colorIndex1},`, 4);
  writer.writeLine(`colorIndex2: ${cre.colorIndex2},`, 4);
  writer.writeLine(`colorIndex3: ${cre.colorIndex3},`, 4);
  writer.writeLine(`colorIndex4: ${cre.colorIndex4},`, 4);
  writer.writeLine(`colorIndex5: ${cre.colorIndex5},`, 4);
  writer.writeLine(`colorIndex6: ${cre.colorIndex6},`, 4);
  writer.writeLine(`colorIndex7: ${cre.colorIndex7},`, 4);
  writer.writeLine(`color1Placement: ${cre.color1Placement},`, 4);
  writer.writeLine(`color2Placement: ${cre.color2Placement},`, 4);
  writer.writeLine(`color3Placement: ${cre.color3Placement},`, 4);
  writer.writeLine(`color4Placement: ${cre.color4Placement},`, 4);
  writer.writeLine(`color5Placement: ${cre.color5Placement},`, 4);
  writer.writeLine(`color6Placement: ${cre.color6Placement},`, 4);
  writer.writeLine(`color7Placement: ${cre.color7Placement},`, 4);
