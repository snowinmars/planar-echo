...
export type CreatureHeaderV10 = Readonly<{
  ...
  intoxication: number;
  luck: number;
  largeSwordsProficiency: number;
  smallSwordsProficiency: number;
  bowsProficiency: number;
  spearsProficiency: number;
  ...
  deity: Maybe<string>;
  diety: Maybe<string>;
  mageType: DefaultMageTypesV10 | string[];
