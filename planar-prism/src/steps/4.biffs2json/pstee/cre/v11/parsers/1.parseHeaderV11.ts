...
export const parseHeaderV11 = ({
  ...
  const fistProficiency = reader.byte();
  const edgedWeaponProficiency = reader.byte();
  const hammerProficiency = reader.byte();
  const axeProficiency = reader.byte();
  const clubProficiency = reader.byte();
  const bowProficiency = reader.byte();
  reader.skip.custom(14);
  ...
  const overlaysOffset = reader.uint();
  const overlaysSize = reader.uint();
  reader.skip.uint(); // currentThiefClassXp
  reader.skip.uint(); // currentMageClassXp
  reader.skip.custom(20);
  reader.skip.ubyte(); // goodIncrementBy
  reader.skip.ubyte(); // lawIncrementBy
  reader.skip.ubyte(); // ladyIncrementBy
  const murderIncrementBy = reader.ubyte();
  const characterType = reader.string(32);
  reader.skip.byte(); // dialogueActivationRange
  reader.skip.byte(); // collisionRadius
  reader.skip.byte();
  ...
  const color3Placement = reader.ubyte();
  const color4Placement = reader.ubyte();
  const color5Placement = reader.ubyte();
  const color6Placement = reader.ubyte();
  const color7Placement = reader.ubyte();
  reader.skip.custom(21);
  reader.skip.byte(); // species
  reader.skip.byte(); // team
  reader.skip.byte(); // faction
