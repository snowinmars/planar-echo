/*
 * Mage-type mapping adapted from Near Infinity (LGPL-2.1).
...
/* createGenerator().register().flags('statusV11',{
...
type StatusV11 = typeof statusV11[keyof typeof statusV11];

/* createGenerator().register().flags('shieldFlagsV11',{
 *   byte1:['normalShield','blackBarbedShield',],
 * }).write();
 */
const shieldFlagsV11 = {
  // byte1
  0x1: 'normalShield',
...
type ShieldFlagsV11 = typeof shieldFlagsV11[keyof typeof shieldFlagsV11];

/* createGenerator().register().flags('attributesV11',{
...
type AttributesV11 = typeof attributesV11[keyof typeof attributesV11];

/* createGenerator().register().shiftedEnum('sexV11', 1,
...
type SexV11 = typeof sexV11[keyof typeof sexV11];
...
/* createGenerator().register().flags('defaultMageTypesV11',{
...
type DefaultMageTypesV11 = typeof defaultMageTypesV11[keyof typeof defaultMageTypesV11];

/* createGenerator().register().enum('specificV11',{
 *   0: ['none'],
 *   1: ['normal'],
 *   2: ['nameless_one'],
 *   3: ['vhailor'],
...
type SpecificV11 = typeof specificV11[keyof typeof specificV11];

/* createGenerator().register().enum('genderV11', {
...
type GenderV11 = typeof genderV11[keyof typeof genderV11];

// TODO [snow]: see parseHeaderV11.ts todo
/* createGenerator().register().enum('objectIdsReferencesV11',
...
type ObjectIdsReferencesV11 = typeof objectIdsReferencesV11[keyof typeof objectIdsReferencesV11];

/* createGenerator().register().enum('alignmentV11', {
...
type AlignmentV11 = typeof alignmentV11[keyof typeof alignmentV11];

export const extendMap = {
  flags: extend(flagsV11),
  status: extend(statusV11),
  shieldFlags: extend(shieldFlagsV11),
  attributes: extend(attributesV11),
  sex: extend(sexV11),
  defaultMageTypes: extend(defaultMageTypesV11),
  specific: extend(specificV11),
  gender: extend(genderV11),
  objectIdsReferences: extend(objectIdsReferencesV11),
  alignment: extend(alignmentV11),
};
export type RawCreHeaderV11 = Readonly<{
  signature: 'cre';
  version: 'v1.1';
  nameRef: number;
  tooltipRef: number;
  ...
  shieldFlags: Maybe<ShieldFlagsV11[]>;
  fieldOfVision: Maybe<number>;
  attributes: Maybe<AttributesV11[]>;
