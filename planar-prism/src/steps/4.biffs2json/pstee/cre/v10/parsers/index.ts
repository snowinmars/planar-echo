export { parseHeaderV10 } from './1.parseHeaderV10.js';
export { parseKnownSpellsV10 } from './2.parseKnownSpellsV10.js';
export { parseSpellMemorizationInfosV10 } from './3.parseSpellMemorizationInfosV10.js';
