...
const readExtendedHeaderV20 = (reader: BufferReader, meta: ItemMeta): ItemExtendedHeaderV20 => {
  ...
  const tmp: PartialWriteable<ItemExtendedHeaderV20> = {};
  ...
  tmp.flags = reader.map.short(offsetMap.flags.parseFlags);
  tmp.anotherAttackType = reader.map.short(offsetMap.anotherAttackType.parse);
  ...
  return {
    ...
    flags: tmp.flags,
    anotherAttackType: tmp.anotherAttackType,
...
export default readExtendedHeaderV20;
