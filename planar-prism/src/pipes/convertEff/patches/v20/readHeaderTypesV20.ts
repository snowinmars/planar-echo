 ...
 *   byte1: null,
 *   byte2: [null,null,'hostile','no los required','allow spotting','outdoors only','non-magical ability','ignore wild surge'],
 *   byte3: ['non-combat ability'],
 * }).write();
 */
const parentResourceFlagsV20 = {
  ...
  // 0x200: unused
  0x400: 'hostile',
  0x800: 'no los required',
  0x1000: 'allow spotting',
  0x2000: 'outdoors only',
  0x4000: 'non-magical ability',
  0x8000: 'ignore wild surge',

  // byte3
  0x10000: 'non-combat ability',
  // 0x20000: unused
  // 0x40000: unused
  // 0x80000: unused
  // 0x100000: unused
...
export type EffectHeaderV20 = Readonly<{
  signature: string;
  version: string;
