...
export const createDlgLogic = (stores: DlgLogicStores): DlgLogic => {
  ...
  return {
    ...
    createItem: ({ itmId, whoId, amount, identified, slotId }) => {
      console.log({ itmId, whoId, amount, identified, slotId });
      return;
    },
    giveItem: ({ itmId, whoId }) => {
      console.log({ itmId, whoId });
      return;
    },
    takeItem: ({ itmId, whoId }) => {
      console.log({ itmId, whoId });
      return;
    },
    takePartyItems: ({ itmId, amount }) => {
      console.log({ itmId, amount });
      return;
    },
    countPartyItem: (itmId) => {
      console.log(itmId);
      return 0;
    },
    hasItem: ({ itmId, whoId }) => {
    ...
    destroyItem: ({ itmId, all }) => {
      console.log({ itmId, all });
      return;
    },
    ...
    transformItem: ({ fromItmId, toItmId, targetId, charge1, charge2, charge3 }) => {
      console.log({ fromItmId, toItmId, targetId, charge1, charge2, charge3 });
      return;
    },
    getAlignment: (whoId) => {
      console.log(whoId);
    ...
    createCreatureNearTo: ({ creWhoId, nearToWhoId }) => {
      console.log({ creWhoId, nearToWhoId });
      return;
    },
    creatureInLocation: ({ creWhoId, location }) => {
      console.log({ creWhoId, location });
      return false;
    },
    ...
    changeDialog: ({ whoId, dlgId }) => {
      console.log({ whoId, dlgId });
      return;
    },
