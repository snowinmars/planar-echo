  ...
  if (!found) {
    return {
      ...
      error: {
        ...
        status: 404,
        message: `Available creatures are not found by path '${concreteGhostDir}'`,
      },
    };
  };
